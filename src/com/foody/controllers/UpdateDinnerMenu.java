...
/**
 * Servlet implementation class UpdateDinnerMenu
 */
@WebServlet("/updateDinnerMenu")
public class UpdateDinnerMenu extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateDinnerMenu() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FoodyDao fd=new FoodyDao();
			   ...
			   try 
		        {
				  check=fd.updateDinnerMenu(addmenu);
