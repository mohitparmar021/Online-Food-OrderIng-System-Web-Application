...
/**
 * Servlet implementation class AddBreakfastMenu
 */
@WebServlet("/addBreakfastMenu")
public class AddBreakfastMenu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FoodyDao fd=new FoodyDao();
			   ...
			   try 
		        {
				  check=fd.addBreakFastMenu(addmenu);
