...
/**
 * Servlet implementation class UpdateBreakfastMenu
 */
@WebServlet("/updateBreakfastMenu")
public class UpdateBreakfastMenu extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateBreakfastMenu() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FoodyDao fd=new FoodyDao();
			   ...
			   try 
		        {
				  check=fd.updateBreakFastMenu(addmenu);
