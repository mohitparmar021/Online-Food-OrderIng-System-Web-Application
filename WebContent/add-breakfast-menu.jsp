...
<body>
	<div class="main">
		...
		<h1 align="center" class="text-white">Add BreakFast Item</h1>
		<div class="main-content">
			<form action="addBreakfastMenu" method="get">

				<div class="form-group  ml-3 mr-3">
					<label for="item_name" class="text-white mt-3"> Item Name</label> <input
						type="text" style="text-transform: capitalize" name="itemName"
						id="" class="form-control bg-dark text-white">
				</div>
				<div class="form-group ml-3 mr-3">
					<label for="price" class="text-white">Price</label> <input
						type="text" required name="price" id="price"
